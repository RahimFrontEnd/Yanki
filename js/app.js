    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".category__slider")) new core(".category__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".category__arrow_left",
                    nextEl: ".category__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".thumbs-sliders__slider")) {
                ...
                new core(".sliders-product__slider", {
                    modules: [ Navigation, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            if (document.querySelector(".search-header__icon")) {
                const searchForm = document.querySelector(".search-header__form");
                document.addEventListener("click", (function(event) {
                    if (event.target.closest(".search-header__icon")) searchForm.classList.toggle("search-open"); else if (!searchForm.contains(event.target)) searchForm.classList.remove("search-open");
                }));
            }
        }));
        window["FLS"] = true;
